...
export default function AddRoomModal({ onClose, onSubmit, loading, error }) {
    ...
    <div className="fixed inset-0 z-50 bg-[#17384F]/60 backdrop-blur-sm flex items-center justify-center p-4 overflow-y-auto">
      <div className="bg-white rounded-3xl p-8 lg:p-10 max-w-3xl w-full shadow-[0_20px_50px_rgba(23,56,79,0.2)] border border-[#D9B77A]/20 my-8">
        <div className="flex justify-between items-start mb-6">
          <div>
            <h3 className="text-[24px] font-bold text-[#17384F] font-display">Add New Room</h3>
            <p className="text-[#17384F]/60 text-[14px] mt-1">Fill in the room details to add it to inventory.</p>
          </div>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-6">
          ...
          <div className="flex items-center justify-end gap-3 pt-4 border-t border-[#17384F]/10">
            ...
            <button type="submit" disabled={loading} className="bg-gradient-to-r from-[#D9B77A] to-[#c4a162] text-white px-8 py-3 rounded-full text-[12px] font-bold uppercase tracking-widest hover:shadow-lg transition-all disabled:opacity-50">
