export default function BookingStatusBadge({ status, type = "booking" }) {
  if (type === "payment") {
    const paymentStyles = {
  ...
  const bookingStyles = {
    Confirmed: "bg-[#1E6F8E]/10 text-[#1E6F8E] border-[#1E6F8E]/30",
  ...
  const style = bookingStyles[status] || "bg-gray-50 text-gray-700 border-gray-200";
