    ...
    <header className="sticky top-0 z-50 w-full bg-[#17384F] border-b-[3px] border-[#D9B77A] shadow-xl">
      <div className="max-w-[1920px] mx-auto h-[88px] flex items-center justify-between px-8 lg:px-16">
        ...
        <div className="flex items-center gap-4">
          {profile?.logo ? (
            <div className="w-11 h-11 rounded-2xl bg-white p-1 border border-[#D9B77A]/40 shadow-sm overflow-hidden flex items-center justify-center shrink-0">
              <img
                src={profile.logo}
                alt={profile.name || "Hotel Logo"}
          ...
          <div className="flex flex-col justify-center">
            <h1 className="text-[22px] sm:text-[26px] font-bold font-display text-white tracking-wide leading-none">
              {profile?.name || "Hotel Management"}
            </h1>
