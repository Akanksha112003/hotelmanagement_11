...
export default function EditGuestModal({ guest, onClose, onSubmit, loading, error }) {
    ...
    if (guest) {
      setForm({
        ...
        dateOfBirth: guest.dateOfBirth
          ...
          : "",
        idProofType: guest.idProofType || "nationalId",
  ...
  const handleSubmit = (e) => {
    ...
    onSubmit({
      ...form,
      totalVisits: Number(form.totalVisits) || 0,
      ...
      <div className="bg-white rounded-3xl max-w-2xl w-full shadow-2xl border border-[#17384F]/10 overflow-hidden my-8 animate-fadeIn">
        ...
        <div className="bg-[#17384F] text-white p-6 md:p-8 flex justify-between items-center">
          <div>
            ...
            <h3 className="text-2xl font-light font-display">Edit Guest Details</h3>
          </div>
          <button
            onClick={onClose}
            type="button"
